...
class Not(Gate):
    ...
    def place_gate(self):
        ...
        self.editor.set_block(x + 0, 51, z + 1, "redstone_wire", {
            "power": "0"
        })
        self.editor.set_block(x + 2, 51, z + 1, "redstone_wire", {
            "power": "0"
        })
        self.editor.set_block(x + 1, 51, z + 1, "redstone_wire", {
            "power": "0"
        })
        self.editor.set_block(x + 1, 51, z + 2, "redstone_wire", {
            "power": "0"
        })

        self.editor.set_block(x + 0, 51, z + 0, "repeater", {
            "facing": "north",
            "delay": "1",
            "powered": "flase",
            "locked": "false"
        })
        self.editor.set_block(x + 2, 51, z + 0, "repeater", {
            "facing": "north",
            "delay": "1",
            "powered": "flase",
            "locked": "false"
        })
        self.editor.set_block(x + 1, 51, z + 3, "repeater", {
            "facing": "north",
            "delay": "1",
            "powered": "flase",
            "locked": "false"
